 ...
 */
public class HikSSLSocketFactory extends SSLSocketFactory {
     ...
     */
    public HikSSLSocketFactory(KeyStore truststore) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
        super(truststore);

...
public class ClearEditText extends AppCompatEditText implements OnFocusChangeListener, TextWatcher {
    ...
    public void setClearCallBack(CallBackClearEditText callBack) {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            /*throw new
                    NullPointerException("You can add dr awableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.drawable.ic_edit_cleare);*/
            mClearDrawable = getResources().getDrawable(R.drawable.ic_edit_cleare);
        }
